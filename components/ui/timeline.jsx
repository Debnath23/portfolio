...
export const Timeline = ({
  ...
  return (
    (<div
      ...
      ref={containerRef}>
      <div className="max-w-7xl pt-10 px-0 md:px-0 lg:px-0">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl font-bold">
          Changelog from my journey
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-lg max-w-sm font-medium">
          Here&apos;s
          ...
          <div key={index} className="flex justify-start pt-5 md:pt-20 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-slate-200 border-neutral-300 dark:border-neutral-700 p-2 dark:border-slate-800" />
              </div>
              <h3
